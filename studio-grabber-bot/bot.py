...
HELP = (
    "👋 Это копилка крутых референсов студии.\n"
    "Пришли ссылку на видео/фото (YouTube, Instagram, TikTok, X и др.) — "
    "я скачаю в максимальном качестве, добавлю в общую папку Google Drive и пришлю ссылку.\n\n"
